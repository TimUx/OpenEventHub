...
> Language: English · [Deutsch (primary)](../DEPLOYMENT.md)
...
Host publishes Traefik only (frontend/admin/API via Host headers). Optional monitoring overlay: `docs/MONITORING.md`.

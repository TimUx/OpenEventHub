...
export const en = {
  ...
  home: {
    ...
    features: {
      ...
      heatmap: {
        title: 'Heatmap',
        description: 'See busy and quiet days from year to day.',
      },
      map: {
        title: 'Map',
  ...
  calendar: {
    ...
    toHeatmap: 'Open event density heatmap',
    weekdays: ['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'],
  },
  heatmap: {
    title: 'Event density',
    description:
      'ECharts heatmap of busy vs quiet days, weekends, and weeks. Zoom from year to day; filter by category and region.',
    metaTitle: 'Event density',
    metaDescription: 'Event density heatmap on OpenEventHub — year, month, week, weekend, and day.',
    toCalendar: 'Open classic calendar',
    previous: 'Previous',
    next: 'Next',
    today: 'Today',
    loading: 'Loading…',
    ...
    many: 'Many',
    chartSeries: 'Events',
    chartHint: 'Apache ECharts calendar heatmap — click a day to zoom one level deeper.',
    filtersToggle: 'Filters',
    filtersActive: 'on',
    filterCategory: 'Category',
    filterRegion: 'Region',
